...
class OnboardingRequest(BaseModel):
    ...
    organization_id: Optional[str] = Field(None, description="Organization ID (uses current user's org if not provided)")
    website_url: Optional[str] = Field(None, description="Full website URL (alternative to domain)")
